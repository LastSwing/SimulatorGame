...
namespace ConclusionEditor
{
    public static class JsonHelper
    {
        ...
        public static void DataExport(Dictionary<string, string> dic, string Name, string path)
        {
            string json = "{";
            int j = 0;
        ...
        /// <returns></returns>
        public static Dictionary<string, string> DataRead(string Name, string path)
        {
            //var path = Application.StartupPath + "/Data/";
